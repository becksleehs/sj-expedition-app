const CACHE='sj-expedition-v4.2.1.0';
const CORE=['./','./index.html','./student.html','./equipment.html','./quiz.html','./css/v3.css','./js/v3-core.js','./js/data.js','./js/v3-core.js','./assets/ui/worldmap-rpg.jpg'];
