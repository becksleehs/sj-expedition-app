const CACHE='sj-expedition-v4.1-arcade';
const CORE=['./','./index.html','./student.html','./equipment.html','./quiz.html','./css/v3.css','./js/v3-core.js','./js/data.js','./assets/ui/worldmap-rpg.jpg'];
