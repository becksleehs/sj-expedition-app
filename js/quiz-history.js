(function(){
  ...
  document.querySelectorAll('.quiz-tabs-v37 button').forEach(b=>b.onclick=()=>{document.querySelectorAll('.quiz-tabs-v37 button').forEach(x=>x.classList.remove('active'));b.classList.add('active');tab=b.dataset.tab;idx=0;render()});updateScore();render();
})();
